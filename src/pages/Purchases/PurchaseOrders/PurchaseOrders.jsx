...
import {PurchaseOrdersCreate} from "./PurchaseOrdersCreate";
...
export const PurchaseOrders = () => {
    ...
    useEffect(() => {
        if (Array.isArray(salePurchaseUser)) {
            ...
            // Filter for billType 'PURCHASE_ORDER'
            filteredData = filteredData.filter((employee) => employee.billType === 'PURCHASE_ORDER');
    ...
    return (
        <>
            {flag ? (
                <Box>
                    <PurchaseOrdersCreate onBooleanChange={handleBooleanChange}/>
                </Box>
            ) : flagView ? (
                <Box>
                    <PurchaseOrdersView onBooleanChange={handleBooleanChangeView} idFlagView={idFlagView}/>
                </Box>
            ) : (
                <Box>
                    <Box>
                        <Box>
                            <Button variant="contained" sx={{margin: "5px"}}>Purchase Order</Button>
