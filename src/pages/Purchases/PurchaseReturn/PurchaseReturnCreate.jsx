...
export const PurchaseReturnCreate = ({onBooleanChange}) => {
    ...
    const [purchaseReturnNo, setPurchaseReturnNo] = useState(handleIncrementNumber());
    const handleSubmitSaleInvoiceCreate = async (e) => {
        e.preventDefault();
        salePurchaseObject["purchaseReturnNo"] = purchaseReturnNo;
        ...
        <Box component="form" onSubmit={handleSubmitSaleInvoiceCreate}>
            <Box sx={{maxHeight: 300}}>
                <Box sx={{marginBottom: "10px"}}>
                    <Button variant="contained">Purchase Return</Button>
                    <Box
                        sx={{
                            right: "0",
                            float: "right",
