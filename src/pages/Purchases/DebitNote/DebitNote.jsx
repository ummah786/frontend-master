...
export const DebitNote = () => {
    ...
    return (
        <>
            {flag ? (
                <Box>
                    <DebitNoteCreate onBooleanChange={handleBooleanChange}/>
                </Box>
            ) : flagView ? (
                <Box>
                    <DebitNoteView onBooleanChange={handleBooleanChangeView} idFlagView={idFlagView}/>
                </Box>
            ) : (
                <Box>
                    <Box>
                        <Box>
                            <Button variant="contained" sx={{margin: "5px"}}>Debit Note</Button>
