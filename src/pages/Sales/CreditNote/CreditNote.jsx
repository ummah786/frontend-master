  ...
  useEffect(() => {
    ...
    return (
        <>
            {flag ? (
                <Box>
                    <CreditNoteCreate onBooleanChange={handleBooleanChange}/>
                </Box>
            ) : flagView ? (
                <Box>
                    <CreditNoteView onBooleanChange={handleBooleanChangeView} idFlagView={idFlagView}/>
                </Box>
            ) : (
                <Box>
                    <Box>
                        <Box>
                            <Button variant="contained" sx={{margin: "5px"}}>Credit Note</Button>
