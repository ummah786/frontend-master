...
export const ProformaInvoiceCreate = ({onBooleanChange}) => {
    ...
    const [proformaExpireDate, setProformaExpireDate] = React.useState(dayjs(getDate()));
        ...
        <Box component="form" onSubmit={handleSubmitSaleInvoiceCreate}>
            <Box sx={{maxHeight: 300}}>
                <Box sx={{marginBottom: "10px"}}>
                    <Button variant="contained">Proforma Invoice</Button>
                    <Box
                        sx={{
                            right: "0",
                            float: "right",
