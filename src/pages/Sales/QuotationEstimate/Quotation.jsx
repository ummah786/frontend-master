...
export const Quotation = () => {
    ...
    useEffect(() => {
        if (Array.isArray(salePurchaseUser)) {
            ...
            filteredData = filteredData.filter((employee) => employee.billType === 'QUOTATION');
    ...
    return (
        <>
            {flag ? (
                <Box>
                    <QuotationCreate onBooleanChange={handleBooleanChange}/>
                </Box>
            ) : flagView ? (
                <Box>
                    <QuotationView onBooleanChange={handleBooleanChangeView} idFlagView={idFlagView}/>
                </Box>
            ) : (
                <Box>
                    <Box>
                        ...
                        <Box>
                            <Box sx={{display: "flex", width: "100%", marginLeft: "-20px", marginTop: "10px"}}>
                                ...
                                <Box sx={{marginBottom: "10px", marginTop: "-8px"}}>
                                    ...
                                    >
                                        {UserRole.showQuotation.map((indi) => (
