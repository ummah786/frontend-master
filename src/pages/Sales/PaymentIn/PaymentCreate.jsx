import {Autocomplete, Box, Checkbox, MenuItem, TableCell, TextField,} from "@mui/material";
...
const PaymentCreate = ({onBooleanChange}) => {
    ...
    const [paymentInNo, setPaymentInNo] = useState(handleIncrementNumber());
    const handleSubmitPaymentCreate = async (e) => {
        ...
        salePurchaseObject["paymentNumberIn"] = paymentInNo;
        ...
        <>
            <Box>
                <Box>
                    ...
                    >
                        <Button onClick={onBooleanChange} variant="contained"
                                sx={{marginRight: "10px", marginTop: "10px", width: "100px"}}>Cancel</Button>
                        <Button
                            type="submit"
