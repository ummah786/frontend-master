...
import {addBusinessUser, addKeyBusiness, removeBusinessUser,} from "../../redux/Action";
...
export const MyBusinessAccount = () => {
    ...
    const handleSubmit = async (event) => {
        manageUserObj['primaryWithBusiness'] = 'N';
    ...
    useEffect(() => {
        ...
        if (primaryUser !== undefined) {
            setPrimaryBusiness(primaryUser);
        }
                            ...
                            <Grid container justifyContent="center" alignItems="center" style={{width: '100%'}}>
                                {primaryBusiness ? (
                                    <Typography variant="h5" gutterBottom>
                                        {primaryBusiness.businessName}-{primaryBusiness.gstNumber}
                                    </Typography>
                                ) : null}
                            </Grid>
                        </AccordionSummary>
                                        ...
                                        <CardContent>
                                            ...
                                            <label htmlFor="image-upload-1">
                                                <Button variant="contained" component="span"
                                                        sx={{marginLeft: "22px", marginBottom: "-10px"}}>
                            ...
                            >
                                ...
                                <Box>
                                    <Button type="submit" variant="contained"
                                            sx={{display: "flex", marginLeft: "245px"}}>SUBMIT</Button>
                                </Box>
                            </Box>
                        </Box>
                    </form>
